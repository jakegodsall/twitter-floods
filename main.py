...
labelled_tweets_dir = tk.Text(dir_frame, height=1)
labelled_tweets_dir.grid(row=1, column=1)
labelled_tweets_dir_browse = ttk.Button(dir_frame)
labelled_tweets_dir_browse.grid(row=1, column=2)

# places
ttk.Label(dir_frame, text="Places: ").grid(row=2, column=0)
places_dir = tk.Text(dir_frame, height=1)
places_dir.grid(row=2, column=1)
places_dir_browse = ttk.Button(dir_frame)
places_dir_browse.grid(row=2, column=2)

# plots
ttk.Label(dir_frame, text="Save: ").grid(row=3, column=0)
save_dir = tk.Text(dir_frame, height=1)
save_dir.grid(row=3, column=1)
save_dir_browse = ttk.Button(dir_frame)
